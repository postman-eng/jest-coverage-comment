...
describe('get coverage report', () => {
  ...
  test('should render coverage title', () => {
    ...
    const { coverageHtml } = getCoverageReport(optionsWithTitle)
    const title = `<summary>${optionsWithTitle.coverageTitle}</summary>`
